...
public class ConfigLoadExtension
{
    ...
    {
        string path = EditorConfigTools.GetSavePath(EnumLoadSettingPath.XmlExternal);
        string pathInternal = EditorConfigTools.GetSavePath(EnumLoadSettingPath.XmlInternal);
