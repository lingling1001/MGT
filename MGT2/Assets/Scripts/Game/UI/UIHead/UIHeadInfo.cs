...
public partial class UIHeadInfo : BaseUI, ILateUpdate
{
    ...
    public override void OnInit()
    {
        ...
        RegisterInterfaceManager.RegisteILateUpdate(this);
    ...
    public void On_LateUpdate(float elapseSeconds, float realElapseSeconds)
    {
    ...
    {
        RegisterInterfaceManager.UnRegisteILateUpdate(this);
